...
},{"_css_loader":"../node_modules/parcel/src/builtins/css-loader.js"}],"js/search-border-controller.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.border_search_controller = void 0;

var border_search_controller = function border_search_controller() {
  var border__box = document.querySelector('.header__border');
  border__box.style.transform = 'translateX(0%)';
};

exports.border_search_controller = border_search_controller;
},{}],"js/search-input-controller.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.search_input_controller = void 0;

var search_input_controller = function search_input_controller() {
  var search_box = document.querySelector('.header__input');
  var search_box_placeholder = document.querySelector('.header__placeholder');
...
exports.search_input_controller = search_input_controller;
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/create-list.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.create_list = void 0;

var create_list = function create_list(books_list, list, wrapper) {
  if (list) {
  ...
  books_list.forEach(function (book) {
    ...
    figure.style.backgroundImage += "url('".concat(book.volumeInfo.imageLinks.thumbnail, "')");
    ...
    var snp = book.searchInfo.textSnippet.split('').splice(0, 250).join('') + '[...]';
    p.innerHTML += snp;
...
exports.api_res = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _createList = require("./create-list");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var api_res = function api_res(string, loading_box) {
  var url = "https://www.googleapis.com/books/v1/volumes?q=".concat(string, "+intitle:keyes");
  var list_wrapper = document.querySelector('.list-wrapper');

  _axios.default.get(url).then(function (res) {
    var books = res.data.items;
    var list = true;
    loading_box.style.display = 'none';
    (0, _createList.create_list)(books, list, list_wrapper);
...
exports.api_res = api_res;
},{"axios":"../node_modules/axios/index.js","./create-list":"js/create-list.js"}],"js/input-api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.input_value = void 0;
...
var input_value = function input_value() {
  var search_box = document.querySelector('.header__input');
  var gif = document.querySelector('.loading-box');
  var list_wrapper = document.querySelector('.list-wrapper');
  search_box.addEventListener('keyup', _lodash.default.debounce(function () {
    var api_value = search_box.value;
    gif.style.display = 'block';
    list_wrapper.innerHTML = null;
    (0, _api.api_res)(api_value, gif);
  }, 2000));
};

exports.input_value = input_value;
},{"lodash":"../node_modules/lodash/lodash.js","./api":"js/api.js"}],"js/app.js":[function(require,module,exports) {
"use strict";

require("../scss/main.scss");

var _searchBorderController = require("./search-border-controller");

var _searchInputController = require("./search-input-controller");

var _inputApi = require("./input-api");

window.addEventListener('load', function () {
  (0, _searchBorderController.border_search_controller)();
  (0, _searchInputController.search_input_controller)();
  (0, _inputApi.input_value)();
});
},{"../scss/main.scss":"scss/main.scss","./search-border-controller":"js/search-border-controller.js","./search-input-controller":"js/search-input-controller.js","./input-api":"js/input-api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
